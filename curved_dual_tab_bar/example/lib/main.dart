      ...
      body: ListView(
        ...
        children: [
          ...
          CurvedDualTabBar(
            ...
            activeGradient: const LinearGradient(colors: [Color(0xFF7C4DFF), Color(0xFFB388FF)]),
            inactiveGradient: const LinearGradient(colors: [Colors.transparent, Colors.transparent]),
            activeTextColor: Colors.white,
          ),
          const SizedBox(height: 24),
          const Text('结合原生 TabBar：曲线背景（CurvedTabBackground）作装饰，切换/滑动交给系统 TabBar'),
          const SizedBox(height: 8),
          CurvedTabBackground(
