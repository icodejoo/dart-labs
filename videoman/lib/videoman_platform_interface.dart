...
import 'videoman_method_channel.dart';

abstract class VmPlatform extends PlatformInterface {
  /// Constructs a VmPlatform.
  VmPlatform() : super(token: _token);

  static final Object _token = Object();

  static VmPlatform _instance = MethodChannelVideoman();

  /// The default instance of [VmPlatform] to use.
  ///
  /// Defaults to [MethodChannelVideoman].
  static VmPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [VmPlatform] when
  /// they register themselves.
  static set instance(VmPlatform instance) {
