...
/// registering a competing gesture recognizer here is how videoman's
...
/// 不注册会竞争的手势识别器，就是 videoman 组件化架构规避冲突的方式，
/// 无需任何特判。
class DouyinGestureLayerComponent extends VmComponent {
...
/// animation trigger, all persistent state lives in [VmFeedController]/
/// [likeNotifier].
///
/// 有状态手势识别器；只持有瞬时的心形动画触发计数，持久状态都在
/// [VmFeedController]/[likeNotifier] 里。
