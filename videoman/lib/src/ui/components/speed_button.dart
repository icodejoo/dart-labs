...
///
/// Purely a UI addition over the existing [VmApi.setRate] — no new core
/// capability was needed.
///
/// 播放倍速循环切换按钮；标签展示当前倍速（如 `1.5x`），点击切换到
/// [_kSpeedSteps] 中的下一档，到头后回绕。
///
/// 只是在既有 [VmApi.setRate] 之上新增的 UI——无需任何新的 core 能力。
class SpeedButtonComponent extends VmComponent {
