...
abstract class VmSttEngine {
  ...
  /// [VmSttCue.start]/[VmSttCue.end] from [atPosition] plus however many
  ...
  /// [VmSttCue.start]/[VmSttCue.end] 都必须由 [atPosition] 加上此后已消费的
  /// 采样数（按其上报的采样率折算）推算得出。
