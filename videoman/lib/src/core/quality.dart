...
class VmQuality {
  ...
  ///
  /// 自适应"自动"档（内核自动选码率）。
  factory VmQuality.auto() => const VmQuality(label: '自动', uri: '', isAuto: true);
}
...
/// ```
List<VmQuality> parseHlsMasterPlaylist(String content, {Uri? base}) {
  final lines = content.split(RegExp(r'\r?\n'));
  final variants = <VmQuality>[];
  ...
  return [VmQuality.auto(), ...variants];
}
