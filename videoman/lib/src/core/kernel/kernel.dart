...
class VmSize {
  ...
  ///
  /// [height] 为帧高度（像素）。
  const VmSize({required this.width, required this.height});
  ...
  bool operator ==(Object other) =>
      other is VmSize && other.width == width && other.height == height;

  @override
  int get hashCode => Object.hash(width, height);

  @override
  String toString() => 'VmSize($width x $height)';
}
