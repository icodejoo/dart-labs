...
/// A [VmKernel] implementation backed by media_kit's `Player`.
///
...
/// engine-agnostic.
///
/// 基于 media_kit `Player` 实现的 [VmKernel]。
///
/// 这是核心层中唯一允许依赖 `package:media_kit` 的文件；`lib/src/core/` 下
/// 其余所有文件都必须与具体引擎无关。
class MpvKernel implements VmKernel {
  ...
  @override
  Stream<VmSize> get size => _sizeController.stream;
