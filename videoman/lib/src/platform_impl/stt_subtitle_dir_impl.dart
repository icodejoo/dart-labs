...
/// The default [VmSttSubtitleDirProvider]: a named folder under the
/// platform's persistent application-support directory, e.g.
/// `<app support>/videoman_stt_subtitles`.
///
...
///
/// 默认的 [VmSttSubtitleDirProvider]：应用持久化支持目录下的一个命名文件夹，
/// 例如 `<app support>/videoman_stt_subtitles`。
///
...
/// core 层必须与插件解耦。
class TempSttSubtitleDirProvider implements VmSttSubtitleDirProvider {
  ...
  const TempSttSubtitleDirProvider({this.folderName = 'videoman_stt_subtitles'});
