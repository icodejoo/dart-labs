...
/// A [VmBrightnessPort] implementation backed by the `screen_brightness`
...
///
/// 基于 `screen_brightness` 插件实现的 [VmBrightnessPort]。读取应用当前屏幕
/// 亮度并应用变更；插件出现任何异常时兜底为亮度 `1.0`。
class ScreenBrightnessPort implements VmBrightnessPort {
  @override
