...
/// The default [VmSttModelDirProvider]: a named folder under the platform's
/// persistent application-support directory, e.g.
/// `<app support>/videoman_stt_models`.
///
...
///
/// 默认的 [VmSttModelDirProvider]：应用持久化支持目录下的一个命名文件夹，
/// 例如 `<app support>/videoman_stt_models`。
///
...
/// core 层必须与插件解耦。
class TempSttModelDirProvider implements VmSttModelDirProvider {
  ...
  const TempSttModelDirProvider({this.folderName = 'videoman_stt_models'});
