...
/// [VmAudioExtractor] built on mpv's `ao=pcm`/`ao-pcm-file` audio-output
...
/// 候选 [VmAudioExtractor]——跟 [MpvFrameExtractor] 抽帧用的"第二个隐藏
...
class MpvAudioExtractor implements VmAudioExtractor {
  ...
  Future<String?> extractWav(String uri) async {
    ...
    try {
      ...
      final outPath =
          '${dir.path}${Platform.pathSeparator}videoman_stt_audio_${DateTime.now().microsecondsSinceEpoch}.wav';
