...
class FvideoController {
  ...
  List<FvideoQuality> _qualities = [];
  FvideoQuality? _currentQuality;
  ...
  List<FvideoQuality> get qualities => List.unmodifiable(_qualities);

  /// The currently selected quality, or null when unknown.
  ///
  /// 当前选中的清晰度；未知时为 null。
  FvideoQuality? get currentQuality => _currentQuality;
  ...
  Future<void> switchQuality(FvideoQuality q) async {
