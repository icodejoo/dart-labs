...
class FvideoQuality {
  ...
  ///
  /// 自适应"自动"档（内核自动选码率）。
  factory FvideoQuality.auto() => const FvideoQuality(label: '自动', uri: '', isAuto: true);
}
...
/// ```
List<FvideoQuality> parseHlsMasterPlaylist(String content, {Uri? base}) {
  final lines = content.split(RegExp(r'\r?\n'));
  final variants = <FvideoQuality>[];
  ...
  return [FvideoQuality.auto(), ...variants];
}
