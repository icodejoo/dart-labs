...
class FvideoSource {
  ...
  /// Example / 示例:
  /// ```dart
  /// final src = FvideoSource('https://host/live.m3u8', type: FvideoStreamType.live);
  /// ```
  const FvideoSource(this.uri, {this.type = FvideoStreamType.vod, this.title});
}
