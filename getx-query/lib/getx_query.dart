/// getx_query — TanStack-Query-style data fetching for GetX.
///
...
/// StaleDuration, RetryResolver, ...) so you only import `getx_query`. The
/// Hook-based symbols that getx_query replaces are hidden.
library;
