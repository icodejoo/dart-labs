/// mova — a media_kit-based (libmpv/ffmpeg) video player library with a
/// self-built gesture control layer for VOD and live playback.
///
/// mova —— 基于 media_kit（libmpv/ffmpeg）的视频播放库，自研手势控制层，
/// 支持点播与直播。
library;
...
export 'src/core/stt/chunk_subtitle_store.dart';
...
export 'src/ui/mini/mini_ctl.dart';
export 'src/ui/mini/mini_host.dart';
export 'src/ui/mini/mini_skin.dart';
export 'src/ui/mini/mini_window.dart';
