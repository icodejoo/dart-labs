...
class MovaState {
  ...
  /// Title of the currently open source, or null before [MovaState] has any
  /// source opened / when the source provides no title.
  ///
  /// Tracked as a first-class state field (rather than outside [MovaState])
  /// so [MovaSelect]s can react directly to title changes, independent of
  ...
  ///
  /// 作为状态的一等字段跟踪（而非放在 [MovaState] 之外），使 [MovaSelect] 能
