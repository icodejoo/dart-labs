...
/// `_centerPlayPause()`。
class CenterPlayComponent extends MovaComp {
  ...
  @override
  List<MovaComp> get children => [PlayPauseComponent()];
...
/// showing a filled play/pause glyph sized/colored from [MovaTheme], driven by
/// [MovaState.playing], calling [MovaApi.playOrPause] on tap.
///
/// 中央大号播放/暂停点按反馈按钮。
///
...
class PlayPauseComponent extends MovaComp {
