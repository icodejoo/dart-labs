...
# Run `pod lib lint mova.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'mova'
  s.version          = '0.3.0'
...
scrub-preview thumbnails, live timeshift, and Android picture-in-picture.
  ...
  s.source           = { :path => '.' }
  s.source_files = 'mova/Sources/mova/**/*'
  ...
  # s.resource_bundles = {'mova_privacy' => ['mova/Sources/mova/PrivacyInfo.xcprivacy']}
end
