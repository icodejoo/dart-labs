...
//
// Animated gradients are explicitly out of scope — see fsvg CLAUDE.md.
//
// 静态 `<linearGradient>`/`<radialGradient>` 支持：色标解析、`href` 继承、
// gradientUnits、spreadMethod、`fill="url(#id)"` 的接线，以及 shader 构建
// （含包围盒退化的保护）。
//
// 动画渐变明确不在范围内——见 fsvg CLAUDE.md。

import 'package:flutter/painting.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:fsvg/src/animation/svg_document_parser.dart';
import 'package:fsvg/src/animation/svg_gradient.dart';
import 'package:fsvg/src/animation/svg_style.dart';
import 'package:fsvg/src/animation/svg_theme.dart';
