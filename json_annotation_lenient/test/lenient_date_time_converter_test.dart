...
void main() {
  group('LenientDateTimeConverter', () {
    ...
    test(
      'parses standard ISO 8601 string with explicit Z regardless of flag',
      () {
    ...
    test('seconds-magnitude epoch int', () {
      ...
      expect(
        result,
        DateTime.fromMillisecondsSinceEpoch(1704067200 * 1000, isUtc: false),
      );
    });
    ...
    test('milliseconds-magnitude epoch int', () {
      ...
      expect(
        result,
        DateTime.fromMillisecondsSinceEpoch(1704067200000, isUtc: false),
      );
    });
    ...
    test('microseconds-magnitude epoch int', () {
      ...
      expect(
        result,
        DateTime.fromMicrosecondsSinceEpoch(1704067200000000, isUtc: false),
      );
    });
    ...
    test('epoch double is rounded', () {
      ...
      expect(
        result,
        DateTime.fromMillisecondsSinceEpoch(1704067200001, isUtc: false),
      );
    });

    test('numeric string is treated as epoch by magnitude', () {
      expect(
        local.fromJson('1704067200000'),
        DateTime.fromMillisecondsSinceEpoch(1704067200000, isUtc: false),
      );
      expect(
        local.fromJson('1704067200'),
        DateTime.fromMillisecondsSinceEpoch(1704067200 * 1000, isUtc: false),
      );
    });
